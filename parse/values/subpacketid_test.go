...
var testSubpacketNames = []string{
	...
	"Preferred Symmetric Ciphers for v1 SEIPD (sub 11)", //11
	"Revocation Key (sub 12)",                           //12
	"Reserved (sub 13)",                                 //13
	"Reserved (sub 14)",                                 //14
	"Reserved (sub 15)",                                 //15
	"Issuer Key ID (sub 16)",                            //16
	"Reserved (sub 17)",                                 //17
	"Reserved (sub 18)",                                 //18
	"Reserved (sub 19)",                                 //19
	...
	"Preferred AEAD Ciphersuites (sub 39)",              //39
	"Unknown (sub 40)",                                  //40
}
