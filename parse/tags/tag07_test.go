...
const (
	...
	Secret-Key (s2k usage 0; plain secret-key material)
		...
		2-octet checksum
			10 d1
`
	tag07Redult2 = `Secret-Subkey Packet (tag 7) (97 bytes)
	05 5c 91 f4 e4 12 00 00 00 32 0a 2b 06 01 04 01 97 55 01 05 01 01 07 40 fa 7c ac af 39 a5 d9 40 b0 78 0a ad a4 3b a7 71 23 e5 be b7 01 58 a5 34 c9 f5 34 62 f6 16 58 0a 03 01 08 07 00 00 ff 4e 74 03 e9 a6 35 35 5b 0a 6a 8c 82 2d 93 1a fe 54 f4 11 4f c6 66 fd 18 b0 ed 4d c5 ea fd ce 88 11 47
	Version: 5 (draft)
		05
	Public-Key
