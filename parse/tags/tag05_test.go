...
`
	...
	Secret-Key (s2k usage 0; plain secret-key material)
		...
		2-octet checksum
			10 55
`
	tag05Redult4 = `Secret-Key Packet (tag 5) (92 bytes)
	05 5c 91 f4 e4 16 00 00 00 2d 09 2b 06 01 04 01 da 47 0f 01 01 07 40 58 59 95 57 15 56 dc 1f fb 6d 71 35 03 d7 f9 e7 0c 24 90 4b d0 c3 dd 7e 3e f9 8a ec 7e 9b 2f 10 00 01 00 87 67 54 a7 49 49 96 ab 11 2c a0 8e 9f 69 c2 15 65 0b ba 9a 98 77 70 11 73 cd 3b dc 9b 99 40 36 0e 5c
	Version: 5 (draft)
		05
	Public-Key
