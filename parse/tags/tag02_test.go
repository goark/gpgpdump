...
`
	...
	Unhashed Subpacket (10 bytes)
		...
		Issuer Key ID (sub 16): 0xb4da3bae7e20b81c
	Hash left 2 bytes
		73 3c
...
`
	...
	Hashed Subpacket (30 bytes)
		...
		Preferred Symmetric Ciphers for v1 SEIPD <critical> (sub 11) (4 bytes)
			09 08 07 02
	...
	Unhashed Subpacket (10 bytes)
		...
		Issuer Key ID (sub 16): 0x8e3dba0ec4dcc3b7
	Hash left 2 bytes
		ef 56
...
`
	...
	Hashed Subpacket (48 bytes)
		...
		Issuer Key ID <critical> (sub 16): 0x910e554478ccde00
	Hash left 2 bytes
		bd fc
	EC point r (253 bits)
...
`
	tag02Redult7 = `Signature Packet (tag 2) (170 bytes)
	05 13 16 08 00 00 00 48 22 21 05 19 34 7b c9 87 24 64 02 5f 99 df 3e c2 e0 00 0e d9 88 48 92 e1 f7 b3 ea 4c 94 00 91 59 56 9b 54 05 02 5c 91 f4 e4 02 1b 03 05 0b 09 08 07 02 03 22 02 01 06 15 0a 09 08 0b 02 04 16 02 03 01 02 1e 07 02 17 80 00 00 00 00 f5 c0 01 02 03 04 05 06 07 08 09 10 11 12 13 14 15 16 00 fe 38 91 df 23 2c 64 c7 84 43 8d 2e ea ec c4 a1 76 ba 51 77 95 fd 2d f0 c0 90 17 44 9c bd 33 cb 34 00 ff 6f b8 bf fb 03 24 df 15 7c 30 cd 28 c3 9d 89 b3 4b 4a 80 85 b2 c3 43 ae 37 37 e3 17 18 12 76 05
	Version: 5 (draft)
		05
	Signiture Type: Positive certification of a User ID and Public-Key packet (0x13)
		13
...
`
	...
	Unhashed Subpacket (10 bytes)
		...
		Issuer Key ID (sub 16): 0x729b523d11f3a8d7
	Hash left 2 bytes
		b1 15
	EC point r (256 bits)
