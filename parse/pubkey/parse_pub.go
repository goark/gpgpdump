...
func (p *Pubkey) rsaPub(item *result.Item) error {
...
func (p *Pubkey) dsaPub(item *result.Item) error {
	mpi, err := values.NewMPI(p.reader)
	if err != nil {
		return errs.Wrap(err)
	}
...
func (p *Pubkey) elgPub(item *result.Item) error {
	mpi, err := values.NewMPI(p.reader)
	if err != nil {
		return errs.Wrap(err)
	}
...
func (p *Pubkey) ecdhPub(item *result.Item) error {
...
func (p *Pubkey) ecdsaPub(item *result.Item) error {
	oid, err := values.NewOID(p.reader)
	if err != nil {
		return errs.Wrap(err)
	}
...
func (p *Pubkey) eddsaPub(item *result.Item) error {
	oid, err := values.NewOID(p.reader)
	if err != nil {
		return errs.Wrap(err)
	}
